                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-8 shadow-lg">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {submitStatus === 'success' && (
                                <div className="bg-green-50 dark:bg-green-900/30 border border-green-400 text-green-700 dark:text-green-400 px-4 py-3 rounded relative">
                    ...
                    <div className="space-y-6">
                        {contactInfo.map((info, index) => (
                            <a
                                ...
                                className="block bg-gray-50 dark:bg-gray-700 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300"
                            >
