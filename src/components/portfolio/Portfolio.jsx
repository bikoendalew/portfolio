          ...
          <ul className="row grid justify-content-center">
            ...
            >
              <figure onClick={toggleModalOne}>
                <img src="img/projects/dappointment.jpg" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title">Doctor Appointment</span>
                </div>
              </figure>
            ...
            >
              <figure onClick={toggleModalTwo}>
                <img src="img/projects/j.png" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title">Blog</span>
                </div>
              </figure>
            ...
            >
              <figure onClick={toggleModalThree}>
                <img src="img/projects/bb.jpg" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title">Blog</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                <img src="img/projects/q.jpg" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title">Quiz app</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                <img src="img/projects/bmi.jpg" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title"> BMI Project</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                <img src="img/projects/T.jpg" alt="Portolio" />
                <div className=" hover-content-wrapper">
                  <span className="content-title"> Task</span>
                </div>
              </figure>
